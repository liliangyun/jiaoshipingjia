...
class IndexController extends Controller
{
     ...
     * autor:xjw129xjt
     */
    public function doPost($id = 0, $cover_id = 0, $title = '', $explain = '', $sTime = '', $eTime = '', $address = '', $district= 0, $limitCount = 0, $deadline = '', $type_id = 0)
    {
        if (!is_login()) {
    ...
    public function detail($id = 0)
    {
		...
		$event_content['district']=D('Addons://ChinaCity/District')->getFullName($event_content['district']);
